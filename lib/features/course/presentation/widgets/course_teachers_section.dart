    ...
    return Column(
      children: [
        ...
        Row(
          children: [
            _CourseTeacherCard(
              courseProfileTeacher: teachers.elementAtOrNull(0),
            ),
            const SizedBox(width: 12),
            _CourseTeacherCard(
              courseProfileTeacher: teachers.elementAtOrNull(1),
            ),
            const SizedBox(width: 12),
            _CourseTeacherCard(
              courseProfileTeacher: teachers.elementAtOrNull(2),
            ),
          ],
        )
      ],
...
class _CourseTeacherCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: (courseProfileTeacher != null)
          ? Container(
