...
class _SearchResultViewState extends ConsumerState<SearchResultView>
  ...
  bool shouldBeInTeachersTab(SearchResult searchResult) =>
      (searchResult.teacher?.isNotEmpty ?? false) ||
      (searchResult.course?.isEmpty ?? true);
  ...
  Widget build(BuildContext context) {
    ...
    if (state.page <= 1) {
      _tabController.index = shouldBeInTeachersTab(searchResult) ? 0 : 1;
    }
