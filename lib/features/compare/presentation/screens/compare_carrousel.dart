...
class CompareCarrousel extends ConsumerStatefulWidget {
  const CompareCarrousel({
    super.key,
    required this.courseId,
  });

  static const String name = "compare_teachers_carrousel";
  static const String route = "/$name";
  final String courseId;

  @override
  ConsumerState<CompareCarrousel> createState() => _CompareCarrousel();
}

class _CompareCarrousel extends ConsumerState<CompareCarrousel> {
                                  ...
                                  children: [
                                    _buildCircularButton(
                                      ...
                                      () {
                                        ref
                                            .read(
                                                courseTeachersControllerProvider
                                                    .notifier)
